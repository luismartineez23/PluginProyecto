...
if(!class_exists('PluginProyecto_commit_type'))
{
    /**
     * Un PostType que almacenará ofertas de empleo con 3 campos meta adicionales
     */
    class PluginProyecto_commit_type
    {
    ...
    } // END class PluginProyecto_commit_type
} // END if(!class_exists('PluginProyecto_commit_type'))